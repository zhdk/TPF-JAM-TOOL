...
def BR_EnvGetProperties(p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11):
  ...
  f=CFUNCTYPE(None,c_uint,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p,c_void_p)(a)
...
def BR_EnvSetProperties(p0,p1,p2,p3,p4,p5,p6,p7):
  ...
  f=CFUNCTYPE(None,c_uint,c_byte,c_byte,c_byte,c_byte,c_int,c_int,c_byte)(a)
...
def NF_GetSWSTrackNotes(p0,p1):
  a=rpr_getfp('NF_GetSWSTrackNotes')
  f=CFUNCTYPE(c_char_p,c_uint,c_uint)(a)
  t=(rpr_packp('MediaTrack*',p0),rpr_packp('WDL_FastString*',p1))
  r=f(t[0],t[1])
  return str(r.decode())
...
def NF_TakeFX_GetOffline(p0,p1):
  a=rpr_getfp('NF_TakeFX_GetOffline')
  f=CFUNCTYPE(c_byte,c_uint,c_int)(a)
  t=(rpr_packp('MediaItem_Take*',p0),c_int(p1))
  r=f(t[0],t[1])
  return r

def NF_TakeFX_SetOffline(p0,p1,p2):
  a=rpr_getfp('NF_TakeFX_SetOffline')
  f=CFUNCTYPE(None,c_uint,c_int,c_byte)(a)
  t=(rpr_packp('MediaItem_Take*',p0),c_int(p1),c_byte(p2))
  f(t[0],t[1],t[2])

def NF_TrackFX_GetOffline(p0,p1):
  a=rpr_getfp('NF_TrackFX_GetOffline')
  f=CFUNCTYPE(c_byte,c_uint,c_int)(a)
  t=(rpr_packp('MediaTrack*',p0),c_int(p1))
  r=f(t[0],t[1])
  return r

def NF_TrackFX_SetOffline(p0,p1,p2):
  a=rpr_getfp('NF_TrackFX_SetOffline')
  f=CFUNCTYPE(None,c_uint,c_int,c_byte)(a)
